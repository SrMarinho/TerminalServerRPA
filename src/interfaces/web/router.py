...
from src.interfaces.web.routes import control, credentials, dev, executions, resolvers, schedules, system, tasks, ui
...
for _mod in (credentials, tasks, executions, control, resolvers, schedules, system):
